...
app.flags.mark_flag_as_required('pipeline_config_path')
app.flags.mark_flag_as_required('trained_checkpoint_prefix')
app.flags.mark_flag_as_required('output_directory')
FLAGS = flags.FLAGS
